(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("require('wiringpi-node')"));
	else if(typeof define === 'function' && define.amd)
		define("pi-home-gpio", ["require('wiringpi-node')"], factory);
	else if(typeof exports === 'object')
		exports["pi-home-gpio"] = factory(require("require('wiringpi-node')"));
	else
		root["pi-home-gpio"] = factory(root["require('wiringpi-node')"]);
...
/***/ "wiringpi-node":
/*!*******************************************!*\
  !*** external "require('wiringpi-node')" ***!
  \*******************************************/
/*! no static exports found */
/***/ (function(module, exports) {

eval("module.exports = __WEBPACK_EXTERNAL_MODULE_wiringpi_node__;\n\n//# sourceURL=webpack://pi-home-gpio/external_%22require('wiringpi-node')%22?");
